...
func (g *Polygon) Area() float64 {
	return doubleArea2(g.FlatCoordinates, 0, g.ends, g.stride) / 2
}
...
func (g *Polygon) LinearRing(i int) *LinearRing {
	...
	return NewLinearRingFlat(g.layout, g.FlatCoordinates[offset:g.ends[i]])
}
...
func (g *Polygon) Push(lr *LinearRing) error {
	...
	g.FlatCoordinates = append(g.FlatCoordinates, lr.FlatCoordinates...)
